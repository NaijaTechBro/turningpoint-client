...
import { Save, CheckCircle, ArrowLeft, Loader2, Beaker } from 'lucide-react';
              ...
              >
                <div className="flex justify-between items-end px-1">
                  ...
                  {field.referenceRange && (
                    <span className="text-[10px] font-bold text-gray-400">Range: {field.referenceRange}</span>
                  )}
                </div>
                
                <div className="relative">
                  {/* --- MAGIC RENDERER: Input vs Select vs Textarea --- */}
                  {field.inputType === 'select' ? (
                    ...
                    <textarea
                      rows="6"
                      required
                      className="w-full p-4 bg-gray-50 border border-gray-200 rounded-2xl outline-none focus:ring-2 focus:ring-brand-blue font-medium text-brand-blue resize-y"
                      value={results[field.fieldName] || ''}
                      onChange={(e) => setResults({...results, [field.fieldName]: e.target.value})}
                    />
                  ) : (
                  ...
                  {/* Unit Label */}
                  {field.unit && field.inputType !== 'select' && field.inputType !== 'textarea' && (
