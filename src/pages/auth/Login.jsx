...
const Login = () => {
  ...
  try {
    ...
    else if (userData.role === 'LabScientist') navigate('/scientist/dashboard');
    else if (userData.role === 'Receptionist') navigate('/receptionist/dashboard');
    else navigate('/');
  ...
  // ... (Keep the exact same return statement/JSX from your previous Login component here)
  return (
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  type="email" required
                  className="focus:ring-brand-orange focus:border-brand-orange block w-full pl-10 sm:text-sm border-gray-300 rounded-lg py-3 border bg-gray-50"
